...
import Slide_2 from '../img/slide2.jpg'
import Slide_3 from '../img/slide3.jpg'
import Slide_4 from '../img/slide4.jpg'
...
class Slider extends React.Component {
    ...
    renderSlides () {
        ...
        return this.state.slides.map((item, index) => (
            <div className='each-slide' key = {index} style = {{backgroundImage: item.eachSlide, width: transition}}>
